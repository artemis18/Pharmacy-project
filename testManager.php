				...
				<div id = "publishedTests">
						...
						//This script shows all the tests.
                                            ...
                                            echo "<br/>";
                                              ...
                                              ?>
							<br/><button disabled = "true" onclick="">View</button>
				</form>
				</div>
                            <div id = "unpublishedTests">
				<form action ="testManager.php" method ="" style ="float: right;" name="unpublishedTest">
						...
						//This script shows all the tests.
                                            ...
                                            echo "<br/>";
                                              ...
                                              ?>
                        <br/><button onclick="">New Test</button> <button onclick="">Deploy Test</button> <button onclick="">Remove Test</button></td>
			</form>	
                        </div>
